;;;============================================================
;;; DiffCheck.lsp v15 (Lightning Cloud Edition)
;;; Uses the O(N log N) fast core but draws Revision Clouds
...
(setq *dc:pad* 50.0)    ; 雲型線往外擴張的邊距
(setq *dc:arc* 30.0)    ; 雲型線的弧長
...
(defun c:DCT ()
  (princ (strcat "\n  Tol=" (rtos *dc:tol* 2 1) " Merge=" (rtos *dc:merge* 2 0) " Pad=" (rtos *dc:pad* 2 0) " Arc=" (rtos *dc:arc* 2 0)))
...
(princ "\nDiffCheck v15 (Lightning Cloud Edition) loaded. Commands: DC, DCC, DCT")
(princ)